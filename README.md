...
**Telomerecat Lite**  Lite is a simplified version of Telomerecat, but it is more flexible for different sequencing platforms (e.g., MGI, Illumina). It is a tool for estimating the average telomere length (TL) for a paired end, whole genome sequencing (WGS) sample.
